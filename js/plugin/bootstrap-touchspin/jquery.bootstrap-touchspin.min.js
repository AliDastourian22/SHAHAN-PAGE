!function(t) {
    "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof module && module.exports ? module.exports = function(n, o) {
            return void 0 === o && (o = "undefined" != typeof window ? require("jquery") : require("jquery")(n)),
                t(o),
                o
        }
        : t(jQuery)
    ...
    t.fn.TouchSpin = function(o) {
        ...
        return this.each(function() {
            function a() {
                "" === b.prefix && (h = g.prefix.detach()),
                "" === b.postfix && (v = g.postfix.detach())
            }
            function e() {
                var t, n, o;
                "" !== (t = b.callback_before_calculation(C.val())) ? 0 < b.decimals && "." === t || (n = parseFloat(t),
                isNaN(n) && (n = "" !== b.replacementval ? b.replacementval : 0),
                (o = n).toString() !== t && (o = n),
                null !== b.min && n < b.min && (o = b.min),
                null !== b.max && n > b.max && (o = b.max),
                    o = function(t) {
                ...
                Number(t).toString() !== o.toString() && (C.val(o),
                    C.trigger("change"))) : "" !== b.replacementval && (C.val(b.replacementval),
                    C.trigger("change"))
            }
            function i() {
                if (b.booster) {
                    var t = Math.pow(2, Math.floor(D / b.boostat)) * b.step;
                    return b.maxboostedstep && t > b.maxboostedstep && (t = b.maxboostedstep,
                        m = Math.round(m / t) * t),
                        Math.max(b.step, t)
                }
                return b.step
            ...
            function r() {
                ...
                isNaN(m) ? m = u() : (t = i(),
                    m += t),
                null !== b.max && m > b.max && (m = b.max,
                    C.trigger("touchspin.on.max"),
                    f()),
                    g.input.val(b.callback_after_calculation(Number(m).toFixed(b.decimals))),
                n !== m && C.trigger("change")
            }
            function c() {
                e();
                var t, n = m = parseFloat(b.callback_before_calculation(g.input.val()));
            ...
            !function() {
                ...
                if (!C.data("alreadyinitialized"))
                    C.data("alreadyinitialized", !0),
                        n += 1,
                        C.data("spinnerid", n),
                        C.is("input") ? (b = t.extend({}, s, j, function() {
                            var n = {};
                        ...
                        "" !== b.initval && "" === C.val() && C.val(b.initval),
                            e(),
                            i = C.val(),
                            u = C.parent(),
                        "" !== i && (i = b.callback_after_calculation(Number(i).toFixed(b.decimals))),
                            C.data("initvalue", i).val(i),
                            C.addClass("form-counter"),
                            u.hasClass("input-group") ? function(n) {
                                n.addClass("bootstrap-touchspin");
                                var o, s, p = C.prev(), a = C.next(), e = '<span class="input-group-addon input-group-prepend bootstrap-touchspin-prefix input-group-prepend bootstrap-touchspin-injected"><span class="input-group-text">' + b.prefix + "</span></span>", i = '<span class="input-group-addon input-group-append bootstrap-touchspin-postfix input-group-append bootstrap-touchspin-injected"><span class="input-group-text">' + b.postfix + "</span></span>";
                                p.hasClass("input-group-btn") || p.hasClass("input-group-prepend") ? (o = '<button class="' + b.buttondown_class + ' bootstrap-touchspin-down bootstrap-touchspin-injected" type="button">' + b.buttondown_txt + "</button>",
                                    p.append(o)) : (o = '<span class="input-group-btn input-group-prepend bootstrap-touchspin-injected"><button class="' + b.buttondown_class + ' bootstrap-touchspin-down" type="button">' + b.buttondown_txt + "</button></span>",
                                    t(o).insertBefore(C)),
                                    a.hasClass("input-group-btn") || a.hasClass("input-group-append") ? (s = '<button class="' + b.buttonup_class + ' bootstrap-touchspin-up bootstrap-touchspin-injected" type="button">' + b.buttonup_txt + "</button>",
                                        a.prepend(s)) : (s = '<span class="input-group-btn input-group-append bootstrap-touchspin-injected"><button class="' + b.buttonup_class + ' bootstrap-touchspin-up" type="button">' + b.buttonup_txt + "</button></span>",
                                        t(s).insertAfter(C)),
                                    t(e).insertBefore(C),
                                    t(i).insertAfter(C),
                                    x = n
                            ...
                            C.on("keydown.touchspin", function(t) {
                                ...
                                38 === n ? ("up" !== N && (r(),
                                    d()),
                                    t.preventDefault()) : 40 === n && ("down" !== N && (c(),
                                    l()),
                                    t.preventDefault())
                            }),
                            ...
                            C.on("blur.touchspin", function() {
                                e(),
                                    C.val(b.callback_after_calculation(C.val()))
                            }),
                            ...
                            C.on("touchspin.destroy", function() {
                                ...
                                n = C.parent(),
                                    f(),
                                    C.off(".touchspin"),
                                    n.hasClass("bootstrap-touchspin-injected") ? (C.siblings().remove(),
                                        C.unwrap()) : (t(".bootstrap-touchspin-injected", n).remove(),
                                        n.removeClass("bootstrap-touchspin")),
                            ...
                            C.on("touchspin.updatesettings", function(n, o) {
                                !function(n) {
                                    (function(n) {
                                            b = t.extend({}, b, n),
                                            n.postfix && (0 === C.parent().find(".bootstrap-touchspin-postfix").length && v.insertAfter(C),
                                                C.parent().find(".bootstrap-touchspin-postfix .input-group-text").text(n.postfix)),
                                            n.prefix && (0 === C.parent().find(".bootstrap-touchspin-prefix").length && h.insertBefore(C),
                                                C.parent().find(".bootstrap-touchspin-prefix .input-group-text").text(n.prefix)),
                                                a()
                                        }
                                    )(n),
                                        e();
                                    var o = g.input.val();
                                    "" !== o && (o = Number(b.callback_before_calculation(g.input.val())),
                                        g.input.val(b.callback_after_calculation(Number(o).toFixed(b.decimals))))
                                }(o)
